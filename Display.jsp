<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <%@page import="Bean.BookDetails,java.util.* " %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Display Book's Details</title>
...
<div class="container">
  <h2 align="center" style="color:#660029"><b><u>Display Book's Details</u></b></h2>
...
<%
ArrayList <BookDetails> al=(ArrayList)session.getAttribute("s1");
Iterator it=al.iterator();
while(it.hasNext())
 {
	 BookDetails e1=(BookDetails)it.next();
	 //out.println(s);
%>
<tbody>
      <tr>
